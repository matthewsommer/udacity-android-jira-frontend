...
public final class Constants  {
    ...
    public static final String MDB_ORIGINAL_TITLE = "summary";
    public static final String MDB_RELEASE_DATE = "creation_date";
    ...
    public static final String MDB_CATEGORY = "project";
